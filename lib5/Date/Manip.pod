...
of perl prior to 5.10. To compensate for this, the Date-Manip-6.xx
distributions (as of Date-Manip-6.10) now include both the current
5.xx and 6.xx releases, and the correct version of Date::Manip will
...
=item B<(*) ParseDate formats removed (ISO 8601 compatibility)>
...
modifications. In other words, today modified to last month modified to
...
year 2000), these will NOT be parseable by Date::Manip. Please note that the
