...
perl modules are currently managed, and since Date::Manip is managed
by then, it's important to avoid causing this type of problem (which I
...
one 15K Date::Manip::Base objects, and any number of small 300 byte
Date::Manip::Date objects.  Date::Manip::Delta objects are even
smaller. Date::Manip::Recur objects are also small, but they
contain any number of Date objects in them.
