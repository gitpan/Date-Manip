...
#    savlett YEAR : The letter(s) used during savings time that year
...
#                                   entire period (which is in savings time)
...
# The date is not adjusted for standard time or daylight savings time
# offsets.
