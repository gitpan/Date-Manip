...
of work to optimize Date::Manip to the point where I hope to
universally recommend it. Check back soon for an updated
recommendation!
...
calendar which improved the definition of leap years.

Date::Manip extrapolates the Gregorian calendar back to the year 0001 AD
and forward to the year 9999 AD, but that does not necessarily mean
...
truly deal with historical dates prior to about 1900.
