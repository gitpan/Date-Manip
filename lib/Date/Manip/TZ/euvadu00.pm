package Date::Manip::TZ::euvadu00;
...
Date::Manip::TZ::euvadu00 - Support for the Europe/Vaduz time zone
...
%Dates         = (
   1    =>
     [
        [ [1,1,2,0,0,0],[1,1,2,0,38,4],'+00:38:04',[0,38,4],
          'LMT',0,[1894,5,31,23,21,55],[1894,5,31,23,59,59] ],
     ],
   1894 =>
     [
        [ [1894,5,31,23,21,56],[1894,6,1,0,21,56],'+01:00:00',[1,0,0],
