package Date::Manip::TZ::euzuri00;
...
Date::Manip::TZ::euzuri00 - Support for the Europe/Zurich time zone
   ...
   1    =>
     [
        [ [1,1,2,0,0,0],[1,1,2,0,34,8],'+00:34:08',[0,34,8],
          'LMT',0,[1848,9,11,23,25,51],[1848,9,11,23,59,59] ],
     ],
   1848 =>
     [
        [ [1848,9,11,23,25,52],[1848,9,11,23,55,36],'+00:29:44',[0,29,44],
          'BMT',0,[1894,5,31,23,30,15],[1894,5,31,23,59,59] ],
     ],
   1894 =>
     [
        [ [1894,5,31,23,30,16],[1894,6,1,0,30,16],'+01:00:00',[1,0,0],
